...
<body class="text-center">
    ...
    <section class="main">
        ...
        <div class="main__contact">
            ...
            <form class="main__form" action="function/validatelogin.php" method="POST">
                <input type="text" name="name_user" placeholder="Ingrese su usuario" class="main__input" required>
                <input type="password" name="password" placeholder="Contraseña" class="main__input" required>
